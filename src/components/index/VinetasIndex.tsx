    ...
    return (
        <section className="flex justify-center flex-col items-center bg-index gap-4">
            ...
            <div className="flex flex-col justify-center items-center">
                ...
                <p className={`${gloria.className} w-[80%] md:w-[65%] lg:w-[50%] font-light text-lg lg:text-2xl text-center mb-12 text-[#321C14]`}>
            ...
            <p className={`${gloria.className} w-[80%] md:w-[65%] lg:w-[50%] font-light text-base lg:text-xl text-center my-12  text-[#321C14]`}>
            ...
            <h2 className={`${gloria.className} w-[80%] md:w-[65%] lg:w-[50%] font-regular text-2xl lg:text-4xl text-center mb-12 text-[#321C14]`}>
                ¿TE GUSTA EL ARTE?
            </h2>
